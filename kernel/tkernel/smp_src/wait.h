 ...
 * timer event queue.
 */
IMPORT void make_wait( TMO tmout, ATR atr );
IMPORT void make_wait_reltim( RELTIM tmout, ATR atr );
 ...
 */
IMPORT void gcb_make_wait( GCB *gcb, TMO tmout );
 ...
 */
IMPORT void gcb_make_wait_with_diswai( GCB *gcb, TMO tmout );
