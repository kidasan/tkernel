...
IMPORT ID tk_rea_dev( ID dd, INT start, VP buf, INT size, TMO tmout );
IMPORT ER tk_srea_dev( ID dd, INT start, VP buf, INT size, INT *asize );
IMPORT ID tk_wri_dev( ID dd, INT start, VP buf, INT size, TMO tmout );
IMPORT ER tk_swri_dev( ID dd, INT start, VP buf, INT size, INT *asize );
IMPORT ID tk_wai_dev( ID dd, ID reqid, INT *asize, ER *ioer, TMO tmout );
IMPORT INT tk_sus_dev( UINT mode );
IMPORT ID tk_get_dev( ID devid, UB *devnm );
IMPORT ID tk_ref_dev( UB *devnm, T_RDEV *rdev );
...
/* Device registration */
/* ALIGN_NO 0x0100 */
IMPORT ID tk_def_dev( UB *devnm, T_DDEV *ddev, T_IDEV *idev );
