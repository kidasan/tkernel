...
IMPORT INT  tm_readdisk( const UB *dev, INT sec, INT nsec, VP addr );
IMPORT INT  tm_writedisk( const UB *dev, INT sec, INT nsec, VP addr );
 ...
 */
IMPORT int bms_printf( const char *format, ... );
