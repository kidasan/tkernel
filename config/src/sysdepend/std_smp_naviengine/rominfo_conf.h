...
/* Kernel address */
#define RI_KERNEL_START	(FP)0x00040000	/* Kernel start address */
#define RI_SYSCONF	SYSCONF		/* SYSCONF top */
#define RI_DEVCONF	DEVCONF		/* DEVCONF top */

/* User definition */
#define RI_USERAREA_TOP	(VP)0x8C000000	/* RAM user area top */
